...
parser.add_argument('--weights', default=os.path.join(os.path.split(sys.argv[0])[0],"Sargassum21b_128_FAI_V3_Nor_valid_best_best_3264.pth"))
...
resimage=Image.fromarray(resimage,'L')
